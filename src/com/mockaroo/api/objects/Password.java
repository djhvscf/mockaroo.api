...
/**
 * Password mockaroo object
 * @author Dennis Hernández Vargas
 * @version 2.0.0 - 27/07/2014
 * @since 2.0.0
 */
public class Password implements IMockarooObject {
	 ...
	 */
	private Password(String columnName) {
		this.setColumnName(columnName);
	}

	/**
	 * Get the {@link Password} object
	 * @param columnName Column name
	 * @return {@link Password} object
	 * @throws MockarooExceptionName 
	 */
	public static Password getInstance(String columnName)
			throws MockarooExceptionName {
		VALIDATOR.validateColumnName(columnName, messageExceptionName);
		if (instance == null) {
			instance = new Password(columnName);
		}
	...
	public String getType() {
		return MockarooType.Password.toString();
	}
}