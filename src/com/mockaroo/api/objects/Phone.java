...
/**
 * Phone mockaroo object
 * @author Dennis Hernández Vargas
 * @version 2.0.0 - 27/07/2014
 * @since 2.0.0
 */
public class Phone implements IMockarooObject {
	 ...
	 */
	private Phone(String columnName) {
		this.setColumnName(columnName);
	}

	/**
	 * Get the {@link Phone} object
	 * @param columnName Column name
	 * @return {@link Phone} object
	 * @throws MockarooExceptionName 
	 */
	public static Phone getInstance(String columnName)
			throws MockarooExceptionName {
		VALIDATOR.validateColumnName(columnName, messageExceptionName);
		if (instance == null) {
			instance = new Phone(columnName);
		}
	...
	public String getType() {
		return MockarooType.Phone.toString();
	}
}
